...
class Practice_19CCE382_Expt_4(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "Narrow-Band", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Narrow-Band")
        ...
        self.settings = Qt.QSettings("GNU Radio", "Practice_19CCE382_Expt_4")
        ...
        self.analog_sig_source_x_0_0_0 = analog.sig_source_f(samp_rate, analog.GR_COS_WAVE, 900, 1, 0, 0)
        self.analog_sig_source_x_0_0 = analog.sig_source_f(samp_rate, analog.GR_COS_WAVE, 1100, 1, 0, 0)
        ...
        self.connect((self.analog_sig_source_x_0_0_0, 0), (self.blocks_sub_xx_0, 1))
        ...
        self.connect((self.blocks_sub_xx_0, 0), (self.blocks_multiply_xx_0, 2))
...
def main(top_block_cls=Practice_19CCE382_Expt_4, options=None):
