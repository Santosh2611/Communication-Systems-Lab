...
class Eye_Without_Noise(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "Eye_Without_Noise", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Eye_Without_Noise")
        ...
        self.settings = Qt.QSettings("GNU Radio", "Eye_Without_Noise")
        ...
        self.analog_sig_source_x_0_0 = analog.sig_source_f(samp_rate, analog.GR_SIN_WAVE, 10, 2, 0, 0)
...
def main(top_block_cls=Eye_Without_Noise, options=None):
