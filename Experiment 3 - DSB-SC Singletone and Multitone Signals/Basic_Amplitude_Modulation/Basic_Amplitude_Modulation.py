...
# Title: Basic_Amplitude_Modulation
# Author: Santosh
# Copyright: 2022
...
class Basic_Amplitude_Modulation(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "Basic_Amplitude_Modulation", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Basic_Amplitude_Modulation")
        ...
        self.settings = Qt.QSettings("GNU Radio", "Basic_Amplitude_Modulation")
...
def main(top_block_cls=Basic_Amplitude_Modulation, options=None):
