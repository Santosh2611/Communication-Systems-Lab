...
# Title: Amplitude_Modulation_WAV_File
# Author: Santosh
# Copyright: 2022
...
class Amplitude_Modulation_WAV_File(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "Amplitude_Modulation_WAV_File", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Amplitude_Modulation_WAV_File")
        ...
        self.settings = Qt.QSettings("GNU Radio", "Amplitude_Modulation_WAV_File")
        ...
        self.low_pass_filter_0 = filter.interp_fir_filter_fff(
            ...
            firdes.low_pass(
                ...
                window.WIN_HAMMING,
                6.76))
        self.blocks_wavfile_source_0 = blocks.wavfile_source('E:\\Plan B\\Amrita Vishwa Vidyapeetham\\Subject Materials\\Semester V\\19CCE382 - Communication Systems Design Lab\\Experiment 3 - DSB-SC Singletone and Multitone Signals\\Amplitude_Modulation_WAV_File\\Impact_Moderato.wav', True)
        self.blocks_wavfile_sink_0 = blocks.wavfile_sink(
            '/home/santosh/19CCE382 - Communication Systems Design Lab/Experiment 3 - AM/Demodulated_Audio',
            1,
            samp_rate,
            blocks.FORMAT_WAV,
        ...
        self.analog_sig_source_x_0_0 = analog.sig_source_f(samp_rate, analog.GR_COS_WAVE, 24000, 1, 0, 0)
        ...
        self.connect((self.blocks_multiply_xx_0, 0), (self.qtgui_sink_x_0_1, 0))
        ...
        self.connect((self.low_pass_filter_0, 0), (self.qtgui_sink_x_0_1_0, 0))
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.low_pass_filter_0.set_taps(firdes.low_pass(1, self.samp_rate, 12000, 120, window.WIN_HAMMING, 6.76))
...
def main(top_block_cls=Amplitude_Modulation_WAV_File, options=None):
