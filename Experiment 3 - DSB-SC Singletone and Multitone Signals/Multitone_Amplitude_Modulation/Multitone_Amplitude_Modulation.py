...
# Title: Multitone_Amplitude_Modulation
# Author: Santosh
# Copyright: 2022
...
class Multitone_Amplitude_Modulation(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "Multitone_Amplitude_Modulation", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Multitone_Amplitude_Modulation")
        ...
        self.settings = Qt.QSettings("GNU Radio", "Multitone_Amplitude_Modulation")
        ...
        self.analog_sig_source_x_0_0_0 = analog.sig_source_f(samp_rate, analog.GR_COS_WAVE, 300000, 1, 0, 0)
        ...
        self.connect((self.analog_sig_source_x_0_0_0, 0), (self.qtgui_sink_x_0_0, 0))
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.low_pass_filter_0.set_taps(firdes.low_pass(1, self.samp_rate, 6000, 60, window.WIN_HAMMING, 6.76))
...
def main(top_block_cls=Multitone_Amplitude_Modulation, options=None):
