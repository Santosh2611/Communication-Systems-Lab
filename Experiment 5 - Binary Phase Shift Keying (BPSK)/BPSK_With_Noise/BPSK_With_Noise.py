...
class BPSK_With_Noise(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "BPSK_With_Noise", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("BPSK_With_Noise")
        ...
        self.settings = Qt.QSettings("GNU Radio", "BPSK_With_Noise")
...
def main(top_block_cls=BPSK_With_Noise, options=None):
